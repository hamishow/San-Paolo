...
def main():
    ...
    operacao = st.sidebar.selectbox('Operação', ['Visualizar Estoque', 'Cadastrar Insumo', 'Registrar Entrada', 'Registrar Saída', 'Cadastrar Receita','Produzir Receita', 'Formatar Insumos'])
